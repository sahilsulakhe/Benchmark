...
public class DefaultMergeStrategy implements MergeStrategy {
    ...
    private boolean isSameReference(final Node node1, final Node node2) {
        Map<String, String> attributes1 = node1.getAttributes();
        String value1 = attributes1.get(REF);
        String value1Lower = value1.toLowerCase();
        Map<String, String> attributes2 = node2.getAttributes();
        String value2 = attributes2.get(REF);
        String value2Lower = value2.toLowerCase();
